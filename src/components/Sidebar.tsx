import { Menu, Play, Pause, FilePen, Key, Plus, PenSquare } from "lucide-react";
    ...
    <>
      {!isOpen && (
        <div className="fixed top-4 left-4 z-50">
          <button
            onClick={onToggle}
            className="h-10 w-10 rounded-lg flex items-center justify-center bg-chatgpt-sidebar hover:bg-token-sidebar-surface-secondary"
          >
